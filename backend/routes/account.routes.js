...
import { allAcc, chnageAccountStatus, getAccountBalance, getAccountByNumber, getFullUserProfile, newAccReqHistory, updateAccountBalance, updateAccountStatus } from "../controllers/account.controller.js";
...
AccountRouter.get("/user/all-details", isAuthenticated, isAdminOrStaff, getFullUserProfile);
